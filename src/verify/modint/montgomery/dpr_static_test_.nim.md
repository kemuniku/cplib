...
data:
  ...
  verifiedWith: []
documentation_of: verify/modint/montgomery/dpr_static_test_.nim
layout: document
redirect_from:
- /library/verify/modint/montgomery/dpr_static_test_.nim
- /library/verify/modint/montgomery/dpr_static_test_.nim.html
