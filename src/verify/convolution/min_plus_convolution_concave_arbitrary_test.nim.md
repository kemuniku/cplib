...
data:
  ...
  code: '# verification-helper: PROBLEM https://judge.yosupo.jp/problem/min_plus_convolution_concave_arbitrary
    ...
    echo minPlusConvolutionConcaveArbitrary(a, b).join(" ")
...
layout: document
redirect_from:
- /verify/verify/convolution/min_plus_convolution_concave_arbitrary_test.nim
- /verify/verify/convolution/min_plus_convolution_concave_arbitrary_test.nim.html
