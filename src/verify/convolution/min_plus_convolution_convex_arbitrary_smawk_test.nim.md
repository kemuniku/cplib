...
data:
  ...
  code: '# verification-helper: PROBLEM https://judge.yosupo.jp/problem/min_plus_convolution_convex_arbitrary
    ...
    echo minPlusConvolutionConvexArbitrarySmawk(a, b).join(" ")
...
layout: document
redirect_from:
- /verify/verify/convolution/min_plus_convolution_convex_arbitrary_smawk_test.nim
- /verify/verify/convolution/min_plus_convolution_convex_arbitrary_smawk_test.nim.html
