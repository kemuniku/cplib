...
data:
  ...
  attributes:
    ...
    links:
    - https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/all/DPL_1_H
  ...
  code: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/all/DPL_1_H\n\
...
layout: document
redirect_from:
- /verify/verify/utils/knapsack/solve_01knapsack_MIM_test.nim
- /verify/verify/utils/knapsack/solve_01knapsack_MIM_test.nim.html
