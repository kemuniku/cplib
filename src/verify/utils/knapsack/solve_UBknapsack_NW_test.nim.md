...
data:
  ...
  code: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/all/DPL_1_C\n\
...
layout: document
redirect_from:
- /verify/verify/utils/knapsack/solve_UBknapsack_NW_test.nim
- /verify/verify/utils/knapsack/solve_UBknapsack_NW_test.nim.html
