...
data:
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/shortest_path\n\
    ...
    \    let a, b, c = ii()\n    G.add_edge(a, b, c)\nlet (path, cost) = G.shortest_path_dijkstra_radix(s,\
    \ t)\nif cost == INF64:\n    echo -1\nelse:\n    echo cost, \" \", path.len -\
  ...
  verifiedWith: []
documentation_of: verify/graph/dynamic/restore_dijkstra_radix_test.nim
layout: document
redirect_from:
- /verify/verify/graph/dynamic/restore_dijkstra_radix_test.nim
- /verify/verify/graph/dynamic/restore_dijkstra_radix_test.nim.html
