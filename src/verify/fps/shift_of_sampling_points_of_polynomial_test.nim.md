...
data:
  ...
  verifiedWith: []
documentation_of: verify/fps/shift_of_sampling_points_of_polynomial_test.nim
layout: document
redirect_from:
- /verify/verify/fps/shift_of_sampling_points_of_polynomial_test.nim
- /verify/verify/fps/shift_of_sampling_points_of_polynomial_test.nim.html
