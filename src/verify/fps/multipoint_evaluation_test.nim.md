...
data:
  ...
  verifiedWith: []
documentation_of: verify/fps/multipoint_evaluation_test.nim
layout: document
redirect_from:
- /verify/verify/fps/multipoint_evaluation_test.nim
- /verify/verify/fps/multipoint_evaluation_test.nim.html
