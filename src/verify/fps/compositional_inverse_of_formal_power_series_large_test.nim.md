...
data:
  ...
  code: '# verification-helper: PROBLEM https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series_large
    ...
    echo f.compositionalInverse(n).join(" ")
  ...
  verifiedWith: []
documentation_of: verify/fps/compositional_inverse_of_formal_power_series_large_test.nim
layout: document
redirect_from:
- /verify/verify/fps/compositional_inverse_of_formal_power_series_large_test.nim
- /verify/verify/fps/compositional_inverse_of_formal_power_series_large_test.nim.html
