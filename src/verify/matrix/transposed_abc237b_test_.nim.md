...
data:
  ...
  verifiedWith: []
documentation_of: verify/matrix/transposed_abc237b_test_.nim
layout: document
redirect_from:
- /library/verify/matrix/transposed_abc237b_test_.nim
- /library/verify/matrix/transposed_abc237b_test_.nim.html
