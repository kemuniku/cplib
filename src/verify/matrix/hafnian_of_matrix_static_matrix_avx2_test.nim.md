...
data:
  ...
  verifiedWith: []
documentation_of: verify/matrix/hafnian_of_matrix_static_matrix_avx2_test.nim
layout: document
redirect_from:
- /verify/verify/matrix/hafnian_of_matrix_static_matrix_avx2_test.nim
- /verify/verify/matrix/hafnian_of_matrix_static_matrix_avx2_test.nim.html
