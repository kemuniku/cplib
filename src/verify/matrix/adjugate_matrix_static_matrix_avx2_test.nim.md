...
data:
  ...
  code: '# verification-helper: PROBLEM https://judge.yosupo.jp/problem/adjugate_matrix
    ...
    const matrixProblem = "adjugate_matrix"
  ...
  verifiedWith: []
documentation_of: verify/matrix/adjugate_matrix_static_matrix_avx2_test.nim
layout: document
redirect_from:
- /verify/verify/matrix/adjugate_matrix_static_matrix_avx2_test.nim
- /verify/verify/matrix/adjugate_matrix_static_matrix_avx2_test.nim.html
