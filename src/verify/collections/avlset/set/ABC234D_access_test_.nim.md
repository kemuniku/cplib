...
data:
  ...
  verifiedWith: []
documentation_of: verify/collections/avlset/set/ABC234D_access_test_.nim
layout: document
redirect_from:
- /library/verify/collections/avlset/set/ABC234D_access_test_.nim
- /library/verify/collections/avlset/set/ABC234D_access_test_.nim.html
