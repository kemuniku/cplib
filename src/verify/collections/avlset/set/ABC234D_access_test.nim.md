...
data:
  ...
  verifiedWith: []
documentation_of: verify/collections/avlset/set/ABC234D_access_test.nim
layout: document
redirect_from:
- /verify/verify/collections/avlset/set/ABC234D_access_test.nim
- /verify/verify/collections/avlset/set/ABC234D_access_test.nim.html
