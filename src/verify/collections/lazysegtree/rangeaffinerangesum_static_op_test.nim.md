...
data:
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/range_affine_range_sum\n\
    ...
    \ mapping(f: F, x: S): S = (f.a * x.val + f.b * x.siz, x.siz)\nproc composition(f:\
    \ F, g: F): F = (f.a * g.a, f.a * g.b + f.b)\nproc id(): F = (mint(1), mint(0))\n\
  ...
  requiredBy: []
  timestamp: '2026-09-03 23:27:59+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/collections/lazysegtree/rangeaffinerangesum_static_op_test.nim
layout: document
redirect_from:
- /verify/verify/collections/lazysegtree/rangeaffinerangesum_static_op_test.nim
- /verify/verify/collections/lazysegtree/rangeaffinerangesum_static_op_test.nim.html
