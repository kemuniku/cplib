...
data:
  ...
  verifiedWith: []
documentation_of: verify/collections/lazysegtree/get_all_static_op_test.nim
layout: document
redirect_from:
- /verify/verify/collections/lazysegtree/get_all_static_op_test.nim
- /verify/verify/collections/lazysegtree/get_all_static_op_test.nim.html
