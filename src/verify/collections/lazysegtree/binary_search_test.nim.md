...
data:
  ...
  verifiedWith: []
documentation_of: verify/collections/lazysegtree/binary_search_test.nim
layout: document
redirect_from:
- /verify/verify/collections/lazysegtree/binary_search_test.nim
- /verify/verify/collections/lazysegtree/binary_search_test.nim.html
