...
data:
  ...
  code: '# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A
    ...
    assert convolution_naive(newSeq[Mint](), @[Mint(1)]) == @[]

    assert convolution(@[Mint(1)], newSeq[Mint]()) == @[]
  ...
  verifiedWith: []
documentation_of: verify/AI/convolution_old_test.nim
layout: document
redirect_from:
- /verify/verify/AI/convolution_old_test.nim
- /verify/verify/AI/convolution_old_test.nim.html
