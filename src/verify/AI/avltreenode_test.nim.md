...
data:
  ...
  code: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/problems/ITP1_1_A\n\
    ...
    \ == 1\nassert root.get(1).key == 3\nassert erased.l.isNil and erased.r.isNil\
    \ and erased.p.isNil\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/AI/avltreenode_test.nim
layout: document
redirect_from:
- /verify/verify/AI/avltreenode_test.nim
- /verify/verify/AI/avltreenode_test.nim.html
