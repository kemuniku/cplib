...
when not declared CPLIB_GRAPH_GENERAL_WEIGHTED_MATCHING_SPARSE:
    const CPLIB_GRAPH_GENERAL_WEIGHTED_MATCHING_SPARSE* = 1
    import cplib/graph/graph
    import cplib/graph/internal/weighted_matching_engine

    proc maximum_weight_matching_sparse*[T: SomeSignedInt](g: WeightedUnDirectedGraph[T] or WeightedUnDirectedStaticGraph[T]): tuple[weight: int64, matching: seq[tuple[u, v: int]]] =
