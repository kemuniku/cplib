...
data:
  ...
  code: "when not declared CPLIB_GRAPH_DIJKSTRA:\n    const CPLIB_GRAPH_DIJKSTRA*\
    ...
    \ algorithm\n    proc restore_dijkstra_impl[T](G: WeightedGraph[T] or UnWeightedGraph,\
    ...
    \ or UnWeightedGraph, start: int or seq[int], ZERO: `t` = `zero`, INF: `t` = `inf`):\
    ...
    \ float32, 0.0'f32, 1e30'f32)\n    proc restore_dijkstra*[T](G: WeightedGraph[T]\
    \ or UnWeightedGraph, start: int or seq[int], ZERO, INF: T): auto =\n        restore_dijkstra_impl(G,\
    \ start, ZERO, INF)\n    proc dijkstra_impl[T](G: WeightedGraph[T] or UnWeightedGraph,\
    ...
    \    proc dijkstra*[T](G: WeightedGraph[T] or UnWeightedGraph, start: int or seq[int],\
    \ ZERO, INF: T): auto =\n        dijkstra_impl(G, start, ZERO, INF)\n    proc\
    \ shortest_path_dijkstra_impl[T](G: WeightedGraph[T] or UnWeightedGraph, start:\
    ...
    \    proc shortest_path_dijkstra*(G: DynamicGraph[int] or StaticGraph[int] or\
    \ UnWeightedGraph, start: int, goal: int, ZERO: int = 0, INF: int = INF64): tuple[path:\
    \ seq[int], cost: int] =\n        shortest_path_dijkstra_impl(G, start, goal,\
    \ ZERO, INF)\n    proc shortest_path_dijkstra*(G: DynamicGraph[int32] or StaticGraph[int32],\
    \ start: int, goal: int, ZERO: int32 = 0.int32, INF: int32 = INF32): tuple[path:\
    \ seq[int], cost: int32] =\n        shortest_path_dijkstra_impl(G, start, goal,\
    ...
    \ ZERO, INF)\n    proc shortest_path_dijkstra*[T](G: WeightedGraph[T] or UnWeightedGraph,\
