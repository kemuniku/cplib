...
data:
  ...
  code: "when not declared CPLIB_MATH_INT128:\n    const CPLIB_MATH_INT128* = 1\n\
    ...
    \u5024\u3068\u3057\u3066\u7D2F\u7A4D\u3057\u3001\u6700\u5C0F\u5024\u3082\u5B89\
    \u5168\u306B\u89E3\u6790\u3059\u308B\u3002\n        bool minus = *p == '-' ? (p++,\
    \ true) : false;\n        const __int128_t base[9] = {1, 10, 100, 1000, 10000,\
    \ 100000, 1000000, 10000000, 100000000};\n        __int128_t result = 0;\n   \
    \     while (1) {\n            size_t sz = 0;\n            for (size_t i=0; i<8;\
    \ i++) {\n                if (*(p + sz) == '\\0') break;\n                sz++;\n\
    \            }\n            result = result * base[sz] - parseint_raw8b_wrap(p,\
    \ sz);\n            p += sz;\n            if (*p == '\\0') break;\n        }\n\
    \        return minus ? result : -result;\n    }\n    constexpr size_t INT128_DIGIT_STRING_SIZE\
    ...
    \        if (x < 0) tmp = -tmp;\n        char* end = std::end(int128_string_buffer)\
    ...
    \ % 10];\n            tmp /= 10;\n        }\n        if (d == end) *(--d) = '0';\n\
    \        if (x < 0) *(--d) = '-';\n        return d;\n    }\n    std::ostream\
    \ &operator<<(std::ostream &dest, __int128_t &x) {\n        // NUL\u7D42\u7AEF\
    \u4ED8\u304D\u306E\u6587\u5B57\u5217\u3092\u30B9\u30C8\u30EA\u30FC\u30E0\u3078\
    ...
    \ EOF && std::isspace(static_cast<unsigned char>(c))) {\n            c = getchar_unlocked();\n\
    \        }\n        bool minus = c == '-';\n        if (c == '-' || c == '+')\
    \ c = getchar_unlocked();\n        __int128_t result = 0;\n        while (c >=\
    ...
    , nodecl.}\n    proc to_int*(x: Int128): int {.importcpp: \"(long long)(#)\",\
    ...
    \  proc lowBits(x: Int128): uint64 {.importcpp: \"((unsigned long long)((__uint128_t)(#)))\"\
    , nodecl.}\n    proc highBits(x: Int128): uint64 {.importcpp: \"((unsigned long\
    \ long)(((__uint128_t)(#)) >> 64))\", nodecl.}\n    proc hash*(x: Int128): Hash\
    \ =\n        ## \u4E0A\u4F4D\u30FB\u4E0B\u4F4D64\u30D3\u30C3\u30C8\u306E\u30CF\
    \u30C3\u30B7\u30E5\u3092\u5408\u6210\u3059\u308B\u3002\u8A08\u7B97\u91CFO(1)\u3002\
    \n        result = !$ (hash(lowBits(x)) !& hash(highBits(x)))\n\n    proc parse_Int128_inner(s:\
    \ cstring): Int128 {.importcpp: \"parse_int128((#))\", nodecl.}\n    proc parseInt128*(s:\
    \ string): Int128 = parse_Int128_inner(cstring(s))\n    proc read_and_parse_int128_inner(x:\
    ...
    \ m != 0\n        if m == 1:\n            return 0\n        result = 1\n     \
    \   var x = x mod m\n        var n = n\n        while n > 0:\n            if (n\
    \ & 1) == 1: result = (result * x) mod m\n            if n > 1:\n            \
    \    x *= x\n                x.mod= m\n            n >>= 1\n    proc to_string_inner(x:\
    \ Int128): cstring {.importcpp: \"to_string((#))\", nodecl.}\n    proc `$`*(x:\
    \ Int128): string = $(to_string_inner(x))\n    proc put_inner*(x:Int128) {.importcpp:\
    \ \"output_int128((#))\", nodecl.}\n    proc put*(x: Int128)=put_inner(x)\n"
  dependsOn: []
