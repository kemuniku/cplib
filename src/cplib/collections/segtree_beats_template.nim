when not declared CPLIB_COLLECTIONS_SEGTREE_BEATS_TEMPLATE:
    ...
    proc initRangeChminChmaxRangeSumMaxMin*[T](v: openArray[T], inf: T, zero: T): RangeChminChmaxRangeSumMaxMin[T] =
        ...
        result.inf = inf
        result.zero = zero
        result.seg.initSegmentTreeBeatsInPlace(vn, op, e(), mapping, composition, id())
