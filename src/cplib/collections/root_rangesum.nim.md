...
data:
  ...
  code: "when not declared CPLIB_COLLECTIONS_ROOTRANGESUM:\n    const CPLIB_COLLECTIONS_ROOTRANGESUM*\
    ...
    \        let actualBlockSize = if bsize > 0: bsize else: max(v.len.float.sqrt.int(),\
