...
data:
  ...
  code: "## AVX-512/AVX2\u3067\u8AD6\u7406\u6F14\u7B97\u30FB\u30B7\u30D5\u30C8\u30FB\
    ...
    \ j = searchNextWordAvx512(unsafeAddr x.bits[0], (i+1).csize_t, x.bits.len.csize_t).int\n\
    ...
    \ array[256, array[8, char]]\n        for value in 0..<256:\n            for bit\
    \ in 0..<8:\n                table[value][bit] = char(ord('0') + ((value shr (7\
