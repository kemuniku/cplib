...
data:
  ...
  code: "when not declared CPLIB_COLLECTIONS_DUALSEGTREE_STATIC_OP:\n    const CPLIB_COLLECTIONS_DUALSEGTREE_STATIC_OP*\
    ...
    \u56F2\u5185\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059: 0 <=\
    \ left and left <= right and right <= self.length\"\n        if left == right:\n\
    ...
    \u7D20\u6570\u3092\u8FD4\u3057\u307E\u3059\u3002\n        self.length\n\n    proc\
    \ `[]`*[ST: DualSegmentTree](self: ST, index: int): ST.S =\n        ## index\u306E\
    \u73FE\u5728\u5024\u3092\u8FD4\u3057\u307E\u3059\u3002\n        self.get(index)\n\
