when not declared CPLIB_GEOMETRY_CCW:
    ...
    proc ccw*[T](p1, p2, p3: Point[T], strict: bool = false): int = ccw(initLine(p1, p2), p3)
    proc online*[T](l: Line[T], p: Point[T]): bool = ccw(l, p) in -1..1
    proc online*[T](p1, p2, p3: Point[T]): bool = ccw(p1, p2, p3) in -1..1
