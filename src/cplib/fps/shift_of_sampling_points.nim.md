...
data:
  ...
  code: "when not declared CPLIB_FPS_SHIFT_OF_SAMPLING_POINTS:\n    const CPLIB_FPS_SHIFT_OF_SAMPLING_POINTS*\
    ...
    \ \u672A\u6E80\u306E f \u306E\u5024 f(0), ..., f(n-1) \u304B\u3089 f(t), ...,\
    \ f(t+m-1) \u3092 O(M(n+m)) \u3067\u6C42\u3081\u308B\u3002\n        ## \u6CD5\
    \ p \u306F\u7D20\u6570\u3001n <= p\u3001m >= 0 \u3092\u8981\u6C42\u3059\u308B\u3002\
    \u7A7A\u306E ys \u306F\u96F6\u591A\u9805\u5F0F\u3068\u3057\u3066\u6271\u3046\u3002\
    \n        doAssert m >= 0, \"\u51FA\u529B\u3059\u308B\u8A55\u4FA1\u70B9\u306E\u500B\
    \u6570\u306F\u975E\u8CA0\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308B\"\n \
    ...
    \        result.setLen(m)\n        for i in count..<m: result[i] = result[i -\
    \ modulus]\n\n    proc shiftOfSamplingPoints*[T: BarrettModint or MontgomeryModint](\n\
  ...
  - verify/AI/many_factorials_test.nim
documentation_of: cplib/fps/shift_of_sampling_points.nim
layout: document
redirect_from:
- /library/cplib/fps/shift_of_sampling_points.nim
- /library/cplib/fps/shift_of_sampling_points.nim.html
