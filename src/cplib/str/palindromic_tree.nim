when not declared CPLIB_COLLECTIONS_PALINDROMIC_TREE:
    ...
    type PalindromicTreeNode*[L,R : static int] = ref object
        link*: array[L..R,PalindromicTreeNode]
        suffix_link*: PalindromicTreeNode
        len, count, id: int

    type PalindromicTree*[L,R : static int] = object
        amax: int
        nodes*: seq[PalindromicTreeNode[L,R]]
        last_node* : PalindromicTreeNode[L,R]
    ...
    proc newPalindromicTreeNode[L,R](pt: var PalindromicTree[L,R], len: int): ref PalindromicTreeNode[L,R] =
