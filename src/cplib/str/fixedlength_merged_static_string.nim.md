...
data:
  ...
  code: "when not declared CPLIB_STR_FIXEDLENGTH_MERGED_STATIC_STRING:\n    const\
    ...
    \                assert left.base == right.base, \"\u6587\u5B57\u5217\u306F\u540C\
    \u3058\u57FA\u5E95\u6587\u5B57\u5217\u304B\u3089\u4F5C\u6210\u3055\u308C\u3066\
    \u3044\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\"\n                merged.base\
    \ = left.base\n                for i in 0..<N:\n                    merged.L[i]\
    \ = left.L[i]\n                    merged.R[i] = left.R[i]\n            else:\n\
    ...
    \     assert 0 <= l and l <= r and r <= len(S), \"\u6307\u5B9A\u3057\u305F\u533A\
    \u9593\u304C\u6709\u52B9\u306A\u7BC4\u56F2\u5185\u3067\u3042\u308B\u5FC5\u8981\
    \u304C\u3042\u308A\u307E\u3059: 0 <= l and l <= r and r <= len(S)\"\n        \
    ...
    \ and M > 0:\n                assert left.base == right.base, \"\u6587\u5B57\u5217\
    \u306F\u540C\u3058\u57FA\u5E95\u6587\u5B57\u5217\u304B\u3089\u4F5C\u6210\u3055\
    \u308C\u3066\u3044\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\"\n       \
    ...
    \u6307\u5B9A\u3057\u305F\u533A\u9593\u304C\u6709\u52B9\u306A\u7BC4\u56F2\u5185\
    \u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059: 0 <= slice.a and\
    \ slice.a <= slice.b + 1 and slice.b < len(S)\"\n        result.base = S.base\n\
    \        var previousLength = 0\n        for i in 0..<N:\n            let currentLength\
    \ = previousLength+int(S.R[i]-S.L[i])\n            let left = max(previousLength,slice.a)\n\
    ...
    \ < U.base.S[ul+commonPrefix.int32()]:\n                    return -1\n      \
