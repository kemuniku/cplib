...
data:
  ...
  code: "when not declared CPLIB_COLLECTIONS_GROUP_UNIONFIND:\n    const CPLIB_COLLECTIONS_GROUP_UNIONFIND*\
    ...
    \ < 0:\n            return x.int32\n        else:\n            self.par_or_siz[x]\
    \ = self.root_i32(self.par_or_siz[x].int)\n            return self.par_or_siz[x]\n\
    ...
    \ = UnionFind(count: self.count, par_or_siz: self.par_or_siz, next: self.next,\
