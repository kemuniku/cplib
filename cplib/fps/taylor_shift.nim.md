...
data:
  ...
  code: "when not declared CPLIB_FPS_TAYLOR_SHIFT:\n    const CPLIB_FPS_TAYLOR_SHIFT*\
    \ = 1\n\n    import cplib/fps/formal_power_series\n    import cplib/modint/modint\n\
    \n    proc taylorShift*[T: BarrettModint or MontgomeryModint](f: seq[T], c: T):\
    \ seq[T] =\n        ## f(x + c) \u306E\u4FC2\u6570\u5217\u3092 O(M(n)) \u3067\u6C42\
    \u3081\u308B\u3002\n        let n = f.len\n        if n == 0: return @[]\n   \
  ...
  - verify/AI/fps_test.nim
documentation_of: cplib/fps/taylor_shift.nim
layout: document
redirect_from:
- /library/cplib/fps/taylor_shift.nim
- /library/cplib/fps/taylor_shift.nim.html
