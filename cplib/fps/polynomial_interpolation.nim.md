...
data:
  ...
  code: "when not declared CPLIB_FPS_POLYNOMIAL_INTERPOLATION:\n    const CPLIB_FPS_POLYNOMIAL_INTERPOLATION*\
    \ = 1\n\n    import cplib/fps/formal_power_series\n    import cplib/fps/product_tree\n\
    \    import cplib/modint/modint\n\n    proc polynomialInterpolation*[T: BarrettModint\
    \ or MontgomeryModint](\n            xs, ys: seq[T]): seq[T] =\n        ## \u3059\
    \u3079\u3066\u306E\u70B9 (xs[i], ys[i]) \u3092\u901A\u308B\u3001\u6B21\u6570\u304C\
    xs.len\u672A\u6E80\u306E\u4E00\u610F\u306A\u591A\u9805\u5F0F\u3092\u8FD4\u3059\
    \u3002\n        doAssert xs.len == ys.len, \"\u88DC\u9593\u3067\u306Fx\u5EA7\u6A19\
    \u3068y\u5EA7\u6A19\u306E\u500B\u6570\u304C\u4E00\u81F4\u3059\u308B\u5FC5\u8981\
    \u304C\u3042\u308B\"\n        if xs.len == 0: return @[]\n        let tree: PolynomialProductTree[T]\
    \ = initPolynomialProductTree[T](xs)\n        let denominators = multipointEvaluation[T](tree.nodes[1].derivative,\
    \ xs)\n        var partial = newSeq[seq[T]](tree.nodes.len)\n        for i in\
    \ 0..<tree.leafCount:\n            if i < xs.len:\n                doAssert denominators[i].val\
    \ != 0, \"\u88DC\u9593\u306B\u4F7F\u3046\u70B9\u306Ex\u5EA7\u6A19\u306F\u4E92\u3044\
    \u306B\u7570\u306A\u308B\u5FC5\u8981\u304C\u3042\u308B\"\n                partial[tree.leafCount\
    \ + i] = @[ys[i] / denominators[i]]\n            else:\n                partial[tree.leafCount\
...
layout: document
redirect_from:
- /library/cplib/fps/polynomial_interpolation.nim
- /library/cplib/fps/polynomial_interpolation.nim.html
